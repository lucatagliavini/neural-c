...
test-defaults:
	...
	$(NATIVE_CC) $(CPPFLAGS) $(CFLAGS) \
		...
		-DNEURAL_DEFAULT_INIT_BATCH_SIZE=3U \
		-DNEURAL_DEFAULT_INIT_SHUFFLE=1 \
		-DNEURAL_DEFAULT_INIT_GRADIENT_CLIP_NORM=0.75 \
		-DNEURAL_DEFAULT_INIT_L1_REGULARIZATION=0.125 \
		-DNEURAL_DEFAULT_INIT_L2_REGULARIZATION=0.25 \
		-DNEURAL_DEFAULT_INIT_REGULARIZE_BIASES=1 \
