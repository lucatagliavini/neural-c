...
static void test_core_contract(void)
{
    ...
    check(NEURAL_DEFAULT_INIT_SHUFFLE == 0 ||
              NEURAL_DEFAULT_INIT_SHUFFLE == 1,
          "default training shuffle must be either zero or one");
